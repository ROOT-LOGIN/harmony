...
namespace Harmony.ILCopying
{
    ...
    public class MethodCopier
	{
		...
		readonly List<TranspilerImpl> transpilers = new List<TranspilerImpl>();
		...
		public void AddTranspiler(TranspilerImpl transpiler)
		{
            if (transpiler != null)
            {
	...
	public class MethodBodyReader
	{
		...
		public void FinalizeILCodes(List<TranspilerImpl> transpilers, Label? endLabel)
		{
			if (generator == null) return;
			...
			var codeInstructions = codeTranspiler.GetResult(generator, method)
				.Select(instruction =>
				{
					...
					if (instruction.opcode == OpCodes.Ret && endLabel != null)
					{
